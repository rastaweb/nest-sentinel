...
import { SentinelModule, ApiKey, TrafficLog, AccessEvent } from '@rastaweb/nest-sentinel';
...
export class AdvancedController {
  ...
  @Post('complex')
  @AccessRule({
    allow: ['10.0.0.0/8', { anyOf: ['192.168.1.0/24', 'MAC:00-14-22-01-23-45'] }],
